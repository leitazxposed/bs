...
<!-- Content -->
	<div class="row" style="margin-top:4px; margin-right:0px; margin-left:0px;margin-bottom:19px ">
		<div class="col-sm-4" style="margin-top:0px">
			<div class="container-fluid bg-1 text-center">
				...
				<img src="<c:url value="/resource/images/aboutImage.png"/>" class="img-circle" alt="AboutUs" width="350"
					height="350">
				<h3>HoopTown, the best around town.</h3>
			</div>
		...
		<div class="container-fluid bg-2 text-center">
			<h3>Who are we?</h3>
			<div id="para"><p>HoopTown purpose is to provide to every single person in the world the best in the game of basketball.</p>
			</div>
			<div id="para"><p>We have always taken pride in our work. There are some core
